 ...
 *
 * <p> Description: JavaFX home page for Role1 users. 
 * Displays user information, navigation buttons, and access 
 * to the Post Dashboard. Implements logout and quit functionality 
 * consistent with FoundationsF25 structure. </p>
 *
 * <p> Copyright: Lynn Robert Carter © 2025 </p>
 *
 * @author Sakeer Abbas Ali
 * @version 1.00 2025-10-16 Initial implementation
 */
...
public class ViewRole1Home {
	...
	protected static Button button_PostDashboard = new Button("Post Dashboard");
	...
	private ViewRole1Home() {
		...
		// GUI Area 2
		// Post Dashboard button (same size as Account Update, placed to its left)
				setupButtonUI(button_PostDashboard, "Dialog", 18, 170, Pos.CENTER, 420, 45);
				button_PostDashboard.setOnAction(e -> {
				    javafx.stage.Stage stage = theStage;
				    guiRole1.PostDashboard dashboard = new guiRole1.PostDashboard(); // or pass a shared PostList if you have one
				    ...
				    stage.setTitle("Posts & Replies Dashboard");
				});
		...
		// Place all of the widget items into the Root Pane's list of children
         theRootPane.getChildren().addAll(
			label_PageTitle, label_UserDetails, button_UpdateThisUser, button_PostDashboard, line_Separator1,
