...
public class ViewAdminHome {
	...
	*/
	...
	private static database.PostList sharedPostList = new database.PostList();
	...
	*/
	...
	private ViewAdminHome() {
		...
		setupButtonUI(button_PostDashboard, "Dialog", 18, 200, Pos.CENTER, 400, 45);
		button_PostDashboard.setOnAction((event) -> {
		    // Open the Post Dashboard
		    guiRole1.PostDashboard dashboard = new guiRole1.PostDashboard();
		    ...
		    theStage.setTitle("Posts & Replies Dashboard");
		});
		...
		setupButtonUI(button_PostDashboard, "Dialog", 16, 250, Pos.CENTER, 290, 270);
		button_PostDashboard.setOnAction((event) -> {
			guiRole1.PostDashboard dashboard = new guiRole1.PostDashboard(sharedPostList);
		    javafx.scene.Scene scene = new javafx.scene.Scene(
		        dashboard.getRoot(),
		        applicationMain.FoundationsMain.WINDOW_WIDTH,
		        applicationMain.FoundationsMain.WINDOW_HEIGHT
